      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="d-flex justify-content-center">
            <img
              src="{{ auth()->user()->foto == 'default.png' ? auth()->user()->pictureDefault : auth()->user()->picture }}"
            ...
            <a href="https://github.com/codenamekii" target="_blank"
              ...
              <div class="d-flex justify-content-between">
                <h6 class="mb-1"><img width="40" height="40" alt="GitHub Logomark" class="height-auto"
                    src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png"></h6>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <form action="{{ route('dashboard.dosen_updateProfile') }}" method="post">
              ...
              <table class="table">
                <tr>
                  <td style="width: 150px !important">NIDN</td>
                  <td>:</td>
                  <td>{{ auth()->user()->nip }}</td>
                </tr>
                <tr>
