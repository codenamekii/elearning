@auth('admin')
  <li class="dropdown{{ request()->routeIs('fakultas.index') ? ' active' : '' }}">
    <a href="{{ route('fakultas.index') }}" class="nav-link"><i data-feather="briefcase"></i><span>Program Studi</span></a>
  </li>
  ...
  <li class="dropdown{{ request()->routeIs('matkuls.index') ? ' active' : '' }}">
    <a href="{{ route('matkuls.index') }}" class="nav-link"><i data-feather="book-open"></i><span>Matakuliah</span></a>
  </li>
